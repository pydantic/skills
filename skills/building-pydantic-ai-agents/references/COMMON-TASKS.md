...
**Hook types:** `before_run`/`after_run`, `before_model_request`/`after_model_request`, `before_tool_execute`/`after_tool_execute`, `wrap_run`, `wrap_model_request`, `on_run_error`, `on_model_request_error`.
